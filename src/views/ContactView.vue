...
// Replace [FORMSPREE_FORM_ID] with your Formspree form ID
...
<template>
  <section class="max-w-lg mx-auto px-4 py-16 pt-24">
    ...
    <div
      ...
      class="p-4 rounded-lg bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200"
    >
      Something went wrong. Please try again.
    </div>

    <!-- Form (idle + submitting) -->
    <form v-else action="https://formspree.io/f/[FORMSPREE_FORM_ID]" method="POST" @submit.prevent="submitForm">
      <!-- Name -->
